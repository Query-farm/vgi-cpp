...
public:
    ...
    virtual std::optional<std::string> kv_get(const std::string& scope, const std::string& key) = 0;
    ...
    virtual int64_t append(const std::string& scope, const std::string& ns, const std::string& key,
                           const std::string& value) = 0;
    ...
    virtual std::vector<std::pair<int64_t, std::string>> scan(const std::string& scope,
                                                              ...
                                                              int64_t after_id, size_t limit) = 0;

    virtual void queue_push(const std::string& scope, const std::vector<std::string>& items) = 0;
